...
## Function: Table 4 robustness check with variance upper/lower bounds
## Author: PK
...
Output_S1 %>% 
  data.frame() %>% 
  fwrite(sep = ",",
         here("Tables", "Table_Output_S1_AsymetricBounds.txt"))
...
Output_S2 %>% 
  data.frame() %>% 
  fwrite(sep = ",",
         here("Tables", "Table_Output_S2_AsymetricBounds.txt"))
...
Output_S3 %>% 
  data.frame() %>% 
  fwrite(sep = ",",
         here("Tables", "Table_Output_S3_AsymetricBounds.txt"))
