...
## Function: Table 4 robustness check with uncertainty as numeric not factor
## Author: PK
...
Output_S1 %>% 
  data.frame() %>% 
  fwrite(sep = ",",
         here("Tables", "Table_Output_S1_NumericUncertainty.txt"))
...
Output_S2 %>% 
  data.frame() %>% 
  fwrite(sep = ",",
         here("Tables", "Table_Output_S2_NumericUncertainty.txt"))
...
Output_S3 %>% 
  data.frame() %>% 
  fwrite(sep = ",",
         here("Tables", "Table_Output_S3_NumericUncertainty.txt"))
