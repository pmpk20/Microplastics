...
## Simpler version to make the paper table
...
Model1_simulation %>% ModelOutput_Paper()
...
# Define your formula for stage_1 and stage_2 models
Model2_stage2_formula <- "-1 + LogBidIncome"

# Call the simulator function
Model2_simulation <- Simulator(data = Data,
                               formula_stage_1 = Model2_stage1_formula,
                               formula_stage_2 = Model2_stage2_formula,
                               R = 100 
)  


Model2_simulation %>% ModelOutput(Identifier = 2)
...
# Define your formula for stage_1 and stage_2 models
Model3_stage2_formula <- "-1 + LogBidIncome"

# Call the simulator function
Model3_simulation <- Simulator(data = Data,
                               formula_stage_1 = Model3_stage1_formula,
                               formula_stage_2 = Model3_stage2_formula,
                               R = 100 
)  

Model3_simulation %>% ModelOutput(Identifier = 3)
...
# Define your formula for stage_1 and stage_2 models
Model4_stage2_formula <- "-1 + LogBidIncome"


# Call the simulator function
Model4_simulation <- Simulator(data = Data,
                               formula_stage_1 = Model4_stage1_formula,
                               formula_stage_2 = Model4_stage2_formula,
                               R = 100 
)  


Model4_simulation %>% ModelOutput(Identifier = 4)
...
# Define your formula for stage_1 and stage_2 models
Model5_stage2_formula <- "-1 + LogBidIncome"

# Call the simulator function
Model5_simulation <- Simulator(data = Data,
                               formula_stage_1 = Model5_stage1_formula,
                               formula_stage_2 = Model5_stage2_formula,
                               R = 100 
)  


Model5_simulation %>% ModelOutput(Identifier = 5)
...
Model6_simulation <- Simulator(data = Data,
                               ...
                               formula_stage_2 = Model6_stage2_formula,
                               R = 100 
)  


Model6_simulation %>% ModelOutput(Identifier = 1)
...
Output <-
  bind_rows(
    ...
    ModelOutput(Model6_simulation, Identifier = 6)
  )
