...
formula_stage_1 <- Model1_stage1_formula <- as.formula(
  MEF ~
    1 + ## intercept here
    AgeDummy + 
    EthnicityDummy +
...
# Define your formula for stage_1 and stage_2 models
formula_stage_2 <- Model1_stage2_formula <- "-1 + LogBidIncome + I((predict(stage_1, type = 'response') + MEC) / 2) + I(0 - predict(stage_1, type = 'variance'))"
