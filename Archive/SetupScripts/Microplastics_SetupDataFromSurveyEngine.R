...
Covariates <-
  here("Data/Raw data", "kent_eapmicro_live_covariates_2022_06_15.xlsx") %>% 
  read_excel() %>% 
  data.frame()


DCE <-
  here("Data/Raw data", "kent_eapmicro_live_dce_2022_06_15.xlsx") %>% 
  read_excel() %>%
  data.frame()


Timers <-
  here("Data/Raw data", "KENT_EAPMICRO_Live_pages_2022_06_15.xlsx") %>% 
  read_excel() %>% 
  data.frame()
...
write.csv(Combined_Trimmed,
          file = paste0("Microplastics_Order0_Long_",Date,".csv"))
write.csv(database,
          file = paste0("Microplastics_Order0_Wide_",Date,".csv"))
